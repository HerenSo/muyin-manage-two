            ...
            <el-col :span="8">
              <el-form ref="form" :model="form" label-width="120px">
                ...
                <el-form-item label="密码">
                  <el-input type="password" v-model="form.loginPwd"></el-input><span class="text-color-placeholder" v-if="form.code">不修改请留空</span>
                </el-form-item>
                <el-form-item label="姓名">
                  <el-input v-model="form.userName"></el-input>
                </el-form-item>
                <el-form-item label="可查看积分上限">
                  <el-input v-model="form.viewLimitIntegral"></el-input>
                </el-form-item>
        ...
        methods: {
            ...
            getDataList(subList) {
                subList.map((data, i) =>{
                    ...
                    // console.log(this.rightList.find((e) => (e == data.code)));
            ...
            submit(){
                this.form.purviewIds = this.rightList;
                ...
                // console.log(this.form)
                this.$axios({
                    url: '/managerInfo/insertOrUpdate',
                    method: 'post',
